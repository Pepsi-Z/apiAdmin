define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'light/user/index' + location.search,
                    add_url: 'light/user/add',
                    edit_url: 'light/user/edit',
                    del_url: 'light/user/del',
                    multi_url: 'light/user/multi',
                    import_url: 'light/user/import',
                    table: 'light_user',
                }
            });
